...
COMPONENT_IMPORTS: Dict[str, List[Dict[str, str]]] = {
    "Group": [{"name": "Stack", "source": "react-native"}],
    "Layout": [
    ...
    "Input_Text": [{"name": "Input", "source": "tamagui"}],
    "Text_Area": [{"name": "TextArea", "source": "tamagui"}],
    "Spinner": [{"name": "Spinner", "source": "tamagui"}],
    "Chart": [{"name": "ChartWidget", "source": "../utils/ChartWidget"}],
    "Image": [{"name": "Image", "source": "react-native"}],
    "Video": [{"name": "VideoView", "source": "expo-video"}],
    "Joystick": [{"name": "Joystick", "source": "react-native-joystick-lite"}],
    "Slider": [
    ...
    "ToastAlert": [{"name": "Toast", "source": "@tamagui/toast"}],
    "FilePickerInput": [{"name": "TouchableOpacity", "source": "react-native"}],
    "datePicker": [{"name": "Button", "source": "tamagui"}],
    "timePicker": [{"name": "Button", "source": "tamagui"}],
    "ColorPicker": [{"name": "Modal", "source": "react-native"}],
    "GoogleMap": [{"name": "MapUnit", "source": "../utils/MapUnit"}],
    "LocalPushNotification": [{"name": "triggerNotification", "source": "../utils/LocalPushNotification"}],
}
...
def _extract_label(comp_type: str, raw_props: Dict[str, Any], comp_id: str) -> str:
    ...
    return human if human else ("Text Content" if _ideeza_type(comp_type) == "Text_Content" else _ideeza_type(comp_type))
